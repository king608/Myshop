				...
				<td class="ta_01" align="center" bgColor="#f5fafe">
						...
						<c:forEach items="${category }" var="category" varStatus="vs">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/adminProduct?method=transitCategory&cid=${category.cid}">
										<img
										src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand">
								</a></td>

								<td align="center" style="HEIGHT: 22px"><a href="javascript:;" onclick="delCategory('${category.cid}')"> <img
					...
					<script type="text/javascript">
						function delCategory(cid){
							if(confirm("您要删除？")){
								location.href="${ pageContext.request.contextPath }/adminProduct?method=delCategory&cid="+cid;
							}
						}
					</script>
				</td>
