...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				//获得当前回显的product的cid
				$("#ShowDiv option[value='${product.category.cid }']").prop("selected",true);
				//是否热门
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct?method=updateProduct&pid=${product.pid}" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select id="ShowDiv" name="categorySecond.csid">
						</select>
					</td>
				</tr>
				<tr>
