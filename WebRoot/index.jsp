	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<c:forEach items="${productHot}" var="hot">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${productNews }" var="news">
					<div class="col-md-2 yes-right-border"
						...
						<p>
							<a href="product_info.html" style='color:#666'>${news.pname }</a>
						</p>
						<p>
							<font color="#E4393C" style="font-size:16px">&yen;${news.shop_price }</font>
						</p>
					</div>
				</c:forEach>
