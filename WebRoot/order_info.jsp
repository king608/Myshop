...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="FromOrder" class="form-horizontal" action="${pageContext.request.contextPath }/order" method="post"
				style="margin-top: 5px; margin-left: 150px;">
				<input type="hidden" id="method" name="method" value="confrimOrder">
			...
			<div style="margin-top: 5px; margin-left: 150px;">
				<strong>选择银行：</strong><span style="color: red">暂时未接通支付方式--请直接提交订单</span>
				<p>
